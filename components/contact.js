    ...
    return (
        <Container className="flex flex-wrap">
            ...
            <div className="flex flex-col lg:flex-row flex-wrap mt-10 w-full justify-around items-center">
                <ContactCard name="Ishadhi Handapangoda" post="Event Coordinator" of="IEEE Student Branch of NSBM" img={IshadiPicture}/>
                <ContactCard name="Chathuranga Senarathna" post="Co - Chairperson" of="Duothan 3.0" img={ChathurangaPicture}/>
                <ContactCard name="Wathsala Gamarachchi" post="Co - Chairperson" of="Duothan 3.0" img={WathsalaPicture}/>
            </div>
        </Container>
    )
}