...
import IEEELogos from "../public/img/IEEELogos.png";
...
export default function Footer() {
  ...
  return (
    <div className="relative mx-5 mb-5 " id="footer">
      <Container>
        <div className="flex justify-around items-center pt-10 mt-5 border-t border-gray-100 dark:border-trueGray-700 ">
          <div className="">
            <Image src={IEEELogos}></Image>
            <div className="flex justify-around items-center">
              <div className="flex mt-10 space-x-5 text-gray-400 dark:text-gray-500 ">
                <a
                ...
                <a
                  href="https://lk.linkedin.com/company/ieeesbnsbm"
                  target="_blank"
                  rel="noopener"
                >
