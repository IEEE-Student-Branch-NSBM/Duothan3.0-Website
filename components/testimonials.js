  ...
  return (
    <Container>
      <div className="w-full">
        ...
        <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3 mt-10 [&>*:nth-child(2)]:order-1 xl:[&>*:nth-child(2)]:order-2">
          <div className="lg:col-span-2 xl:col-auto xl:self-end">
